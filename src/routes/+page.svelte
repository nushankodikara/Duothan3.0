...
<div class="h-screen relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="absolute left-10 bottom-20 mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-y-6 gap-x-8 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
        <div>
            <button type="submit" class="group relative flex w-full justify-center rounded-full border border-transparent bg-cyan-600 py-2 px-4 text-sm font-medium text-white hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:cyan-cyan-500 focus:ring-offset-2">
              GET STARTED
            </button>
            <span class="mt-6">
