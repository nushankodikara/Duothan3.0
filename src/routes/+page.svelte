...
<div class="h-screen relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    <img src="header.jpg" alt="header" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center">
    ...
    <div class="absolute left-10 bottom-20 mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-y-6 gap-x-8 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
        <div>
            ...
            <div>
                <button type="submit" class="flex-none rounded-md bg-cyan-500 py-2.5 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-500">Search</button>
            </div>
        </div>
      </div>
    </div>
